...
public class LightsOutGame {
     ...
     */
    public LightsOutGame(Context context) {
        this(context, 7);
    }
     ...
     */
    public LightsOutGame(Context context, int numButtons) {
    ...
    public String stringForGameState() {
        ...
        if(this.checkForWin()){
            return this.context.getResources().getString(R.string.gameWin);
        }
        if(this.mNumPresses == 0){
            return this.context.getResources().getString(R.string.startOfGame);
        }
        return this.context.getResources().getQuantityString(R.plurals.pressCount, this.getNumPresses(), this.getNumPresses());
    }
